                ...
                <div class="col-md-6 mx-auto">
                    <div class="d-flex flex-row justify-content-between align-items-center">
                        <div class="options d-flex flex-row justify-content-between align-items-center ">
                            <div class="r mr-3" :class="yourWeapon == 'Rock' ? 'checked' : ''" @click="changeWeapon('Rock')"></div>
                            <div class="p mr-3" :class="yourWeapon == 'Paper' ? 'checked' : ''" @click="changeWeapon('Paper')"></div>
                            <div class="s mr-3" :class="yourWeapon == 'Scissor' ? 'checked' : ''" @click="changeWeapon('Scissor')"></div>
                        </div>
                        <div class="game">
                            <div class="chooseWeapon " v-if="!yourWeapon">Choose your Weapon</div>
                            <div class="fight " v-if="yourWeapon && !result" v-show="!fighting" @click.once="fight">FIGHT</div>    
